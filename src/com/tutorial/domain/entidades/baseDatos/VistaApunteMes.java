...
public class VistaApunteMes implements JSONStreamAware, Serializable {
	...
	public VistaApunteMes() {
		super();
		// TODO Auto-generated constructor stub
	}
	
	public VistaApunteMes(Integer idVista, BigDecimal ingresos,
	...
	public void writeJSONString(Writer out) throws IOException {
		LinkedHashMap obj = new LinkedHashMap();
		  ...
		  obj.put("idCuenta", new Integer(idVista));
