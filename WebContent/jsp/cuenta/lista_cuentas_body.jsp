...
<h1 class="pagetitle"><bean:message key="cuentas.listado.titulo"/></h1>
<html:form styleId="fomulario" action="/cuentaRedirect" method="post">
...
<display:table class="formulario" name="sessionScope.listado-cuentas" pagesize="<%=Constantes.LISTA_CORTA%>" id="iddisplay" keepStatus="false" defaultsort="1" defaultorder="ascending">
    ...
    <display:column headerClass="top" titleKey="cuentas.listado.tabla.dni.titular" >
		<html:link page="/action/cuentaRedirect" paramId="id" paramName="iddisplay" paramProperty="idCuenta" >
    ...
    <display:column headerClass="top" titleKey="cuentas.listado.tabla.numero">
		<a href="<%=request.getContextPath()%>/action/cuentaRedirect?id=<bean:write name="iddisplay" property="idCuenta"/>">
