	...
	var imgDir = "/ContaNetApp/img/";		// directory for images ... e.g. var imgDir="/img/"
    ...
    */
	...
	if (dom)
	{
		...
		document.write ("<div onclick='bShow=true' id='calendar' style='z-index:+999;position:absolute;visibility:hidden;'>" +
				"<table width="+((showWeekNumber==1)?250:220)+" style='font-family:arial;font-size:11px;border-width:1;border-style:solid;border-color:#a0a0a0;font-family:arial; font-size:11px}' bgcolor='#ffffff'>" +
						"<tr background='/ContaNetApp/img/calback.jpg'>" +
							"<td >" +
								"<table width='"+((showWeekNumber==1)?244:218)+"'>" +
									"<tr>" +
										"<td style='padding:2px;font-family:arial; font-size:11px;'>" +
											"<font color='#FFFFFF'>" +
												"<B><span id='caption'></span></B>" +
											"</font>" +
										"</td>" +
										"<td align=right>" +
											"<a href='javascript:hideCalendar()'>" +
												"<IMG SRC='"+imgDir+"close.gif' BORDER='0' ALT='Close the Calendar'>" +
											"</a>" +
										"</td>" +
									"</tr>" +
								"</table>" +
